"""
=============================================================================
CROP YIELD PREDICTION — MAIN PIPELINE ORCHESTRATOR (new_model2 / Old Dataset)
=============================================================================
Executes the complete modern CYP pipeline end-to-end:

  Stage 1: Preprocessing (Clean → Lag → Safe Encoding → Leakage-free Scaling)
...
Usage:
  ...
  python3 main.py --stage 2        # Resume from stage 2
  python3 main.py --only 4         # Run only evaluation
=============================================================================
"""
...
def banner():
    print("\n")
    print("+" + "="*70 + "+")
    print("|" + " "*8 + "CROP YIELD PREDICTION (CYP) — OLD DATASET PIPELINE" + " "*12 + " |")
    print("|" + " "*8 + "Stacking (A) & LSTM-XGBoost Hybrids (B/C)" + " "*20 + " |")
    print("+" + "="*70 + "+")
    print("|  Stage 1: Clean, Lag & Safe Preprocessing (Country / Crop)          |")
...
def main():
    parser = argparse.ArgumentParser(description='CYP Old Dataset Pipeline Orchestrator')
    ...
    # Need to add BASE_DIR to sys.path so module imports work
